...
map_unit = soildb.fetch_ssurgo_mapunit_by_point.sync(38.5, -121.5)
pedon = soildb.fetch_labpedon_by_id.sync("S1999NY061001")
...
# Or async
async with soildb.SDAClient() as client:
    map_unit = await soildb.fetch_ssurgo_mapunit_by_point(38.5, -121.5, client=client)
    pedon = await soildb.fetch_labpedon_by_id("S1999NY061001", client=client)
```
...
map_unit = await soildb.fetch_ssurgo_mapunit_by_point(
    38.5, -121.5,
...
pedon = await soildb.fetch_labpedon_by_id(
    "S1999NY061001",
    horizon_columns=[
